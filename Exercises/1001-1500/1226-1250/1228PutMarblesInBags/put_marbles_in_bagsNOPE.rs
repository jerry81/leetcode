...
impl Solution {
  ...
  fn build_hashmap(weights: &Vec<i32>, k: i32) -> HashMap<(usize,usize), i64> {
    ...
    let mut starter = 0;
    for group in 0..ku {
      let rem_groups = ku - group;
      let possible_group_size = n-starter-rem_groups;
      println!("group is {} possiblegroupsize is {}", group, possible_group_size);
      for ender in starter..possible_group_size {
